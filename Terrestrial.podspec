...
This cocoapod allows you to quickly get your app localized.
  ...
  s.homepage         = "http://terrestrial.io"
  s.license          = 'MIT'
  ...
  s.ios.resource = "Frameworks/TerrestrialPhotoshoot.framework"
  s.ios.xcconfig = { 'LD_RUNPATH_SEARCH_PATHS' => '"$(PODS_ROOT)/Terrestrial/Frameworks/TerrestrialPhotoshoot.framework"' }
